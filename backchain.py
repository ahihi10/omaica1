...
from bttd_lab1_backward_rule import RULES
...
def backchain_to_goal_tree(rules, hypothesis):
    ...
    for rule in rules:
        ...
        if test_match:
            a = dict(list(a.items())+list(test_match.items()))
    print(a)
...
# it to see it work:
a= backchain_to_goal_tree(RULES, 'Gotti is a criminal')
print(a)
b= backchain_to_goal_tree(RULES, 'Cagoni gets out of jail')
print(b)
